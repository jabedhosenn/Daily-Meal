...
const displayProducts = (data) => {
  ...
  if (data.meals) {
        ...
        meal.strMeal
                    ...
                    <div class="card-footer">
                        <button  onclick="singleMeal('${
                          meal.idMeal
                        }')"  class="btn btn-info w-100" data-bs-toggle="modal" data-bs-target="#exampleModal"> Details </button>
                    </div>
                </div>
    ...
    container.innerHTML = `<h4 class="text-danger">Item not found!</h4>`;
  }
};
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <h5 class="card-title text-success">Category: ${
                      meal.strCategory
                    } </h5>
                    <h5 class="card-title text-success">Origin: ${
                      meal.strArea
                    } </h5>
                    <p class="card-text">${meal.strInstructions.slice(
                      0,
